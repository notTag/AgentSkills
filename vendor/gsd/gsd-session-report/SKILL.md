...
<execution_context>
@$HOME/.claude-wakelax/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @$HOME/.claude-wakelax/get-shit-done/workflows/session-report.md end-to-end.
</process>
