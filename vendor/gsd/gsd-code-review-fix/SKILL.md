...
<execution_context>
@$HOME/.claude-wakelax/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @$HOME/.claude-wakelax/get-shit-done/workflows/code-review-fix.md end-to-end.
