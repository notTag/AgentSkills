...
Read and execute `$HOME/.claude-wakelax/get-shit-done/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `$HOME/.claude-wakelax/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `$HOME/.claude-wakelax/get-shit-done/workflows/discuss-phase.md` end-to-end.
