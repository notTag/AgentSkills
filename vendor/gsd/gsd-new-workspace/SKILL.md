...
<execution_context>
@$HOME/.claude-wakelax/get-shit-done/workflows/new-workspace.md
@$HOME/.claude-wakelax/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @$HOME/.claude-wakelax/get-shit-done/workflows/new-workspace.md end-to-end.
