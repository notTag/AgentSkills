...
<execution_context>
@$HOME/.claude-wakelax/get-shit-done/workflows/list-workspaces.md
@$HOME/.claude-wakelax/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @$HOME/.claude-wakelax/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
