...
<execution_context>
@$HOME/.claude-wakelax/get-shit-done/workflows/import.md
@$HOME/.claude-wakelax/get-shit-done/references/ui-brand.md
@$HOME/.claude-wakelax/get-shit-done/references/gate-prompts.md
@$HOME/.claude-wakelax/get-shit-done/references/doc-conflict-engine.md
</execution_context>
...
Run: `node "$HOME/.claude-wakelax/get-shit-done/bin/gsd-tools.cjs" from-gsd2`
