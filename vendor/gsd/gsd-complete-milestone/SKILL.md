...
- @$HOME/.claude-wakelax/get-shit-done/workflows/complete-milestone.md (main workflow)
- @$HOME/.claude-wakelax/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
